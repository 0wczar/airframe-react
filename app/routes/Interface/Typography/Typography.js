                    ...
                    <HeaderDemo
                        ...
                        subTitle={
                            <React.Fragment>
                                ...
                                color utility classes. Includes support for
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Use any of these color variables as they are or
                                reassign them to more meaningful variables for
                                your project.
                            </p>
                            <div>
                        ...
                        <CardBody>
                            ...
                            <div>
                                ...
                                <p className='text-gray-300 p-2 bg-dark'>
                                    This is an example for{' '}
                                    <code>.text-gray-300</code>
                                </p>
                                <p className='text-gray-400 p-2 bg-dark'>
                                    This is an example for{' '}
                                    <code>.text-gray-400</code>
                                </p>
                ...
                <Col lg={6}>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Traditional heading elements are designed to
                                work best in the meat of your page content. When
                                you need a heading to stand out, consider using
                                a display heading—a larger, slightly more
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                ...
                                small secondary heading text from Bootstrap 4
                            </p>
                            <div>
                                <h1 className='mb-0'>
                                    h1. Custom
                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text text-justify'>
                                ...
                                diem certam indicere. Cras mattis iudicium purus
                                sit amet fermentum.
                            </p>
                        </CardBody>
                    </Card>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Transform text in components with text
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Change a selection to our monospace font stack
                                with <code>.text-monospace</code>.
                            </p>
                ...
                <Col lg={6}>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Add <code>.initialism</code> to an abbreviation
                ...
                <Col lg={6}>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Use text utilities as needed to change the
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                ...
                                for identifying the source. Wrap the name of the
                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                ...
                                <code>&lt;code&gt;</code>. Be sure to escape
                                HTML angle brackets.
                            </p>
                        </CardBody>
                    </Card>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Use the <code>&lt;kbd&gt;</code> to indicate
                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                For indicating sample output from a program use
                                the <code>&lt;samp&gt;</code> tag.
                            </p>
                            <samp>
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='card-text'>
                                Use <code>&lt;pre&gt;</code>s for multiple lines
                                of code. Once again, be sure to escape any angle
                                brackets in the code for proper rendering. You
                                may optionally add the{' '}
                                <code>.pre-scrollable</code> class, \ which will
                                set a max-height of 340px and provide a y-axis
                                scrollbar.
                            </p>
                            <code>
