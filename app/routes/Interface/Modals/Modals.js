        ...
        <Row>
            <Col lg={12}>
                <HeaderDemo
                    ...
                    subTitle={
                        <React.Fragment>
                            Use modal plugin to add dialogs to your site for
                ...
                <Card className='mb-3 text-center'>
                    <CardBody>
                        ...
                        <UncontrolledModal target='modalDefault102'>
                            <ModalHeader tag='h6'>
                                <i className='fa fa-envelope-o mr-2'></i> Modal:
                                Icons
                                <span className='small ml-1 text-muted'>
                                    #1.02
                                </span>
        ...
        <Row>
            <Col lg={12}>
                <HeaderDemo
                    ...
                    subTitle={
                        <React.Fragment>
                            You can apply colors to make them easier to see for
                            users. All colors work from the section
                        ...
                        >
                            ...
                            <ModalBody className='text-center px-5'>
                                ...
                                <p className='modal-text'>
                                    We're glad to see you again and wish you a
                                    nice day.
                                </p>
                                <UncontrolledModal.Close
                                    color='primary'
                    ...
                    <CardBody className='table-info'>
                        ...
                        >
                            ...
                            <ModalBody className='table-info text-center px-5'>
                                ...
                                <h6>Information</h6>
                                <p className='modal-text'>
                                    This alert needs your attention, but it's
                                    not important.
                                </p>
                                <UncontrolledModal.Close
                                    color='info'
