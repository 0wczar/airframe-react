                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p>
                                Make the link active with <code>active</code>{' '}
                                class.
                            </p>
                            <UncontrolledButtonDropdown>
                                <DropdownToggle caret color='secondary' outline>
                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p>
                                Disable the link with <code>disabled</code>{' '}
                                class.
                            </p>
                            <UncontrolledButtonDropdown>
                                <DropdownToggle caret color='secondary' outline>
                ...
                <Col lg={6}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p>
                                Basic <code>header</code> styling of label
                                sections.
                            </p>
                            <UncontrolledButtonDropdown>
                                <DropdownToggle caret color='secondary' outline>
            ...
            <Row>
                <Col lg={12}>
                    <HeaderDemo
                        ...
                        subTitle={
                            <React.Fragment>
                                Dropdown as combo with Lists, Buttons, Input and
                                Media...
                            </React.Fragment>
                        }
                    />
