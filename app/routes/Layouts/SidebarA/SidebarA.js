...
export const SidebarA = () => (
    <Container>
        ...
        <p className='mb-5'>
            Welcome to the <b>&quot;Airframe&quot;</b> Admin Dashboard Theme
            based on{' '}
            <a
        ...
        <section className='mb-5'>
            ...
            <ul className='pl-3'>
                ...
                <li>
                    ...
                    - technical details of which versions are used for this
                    framework.
                </li>
                <li>
                    <a
                ...
                <li>
                    <b>Bugs</b> - do you see errors in this version? Please
                    report vie email: <i>info@webkom.co</i>
                </li>
            </ul>
        </section>
        ...
        <section className='mb-5'>
            ...
            <ul className='pl-3'>
                <li>
                    <a href='http://dashboards.webkom.co/jquery/airframe'>
                        jQuery
                    </a>{' '}
                    - based on the newest <i>Bootstrap 4.x</i>
                </li>
                <li>
                    <a href='http://dashboards.webkom.co/react/airframe'>
                        React
                    </a>{' '}
                ...
                <li>
                    <a href='http://dashboards.webkom.co/net-mvc/airframe'>
                        .NET MVC
                    </a>{' '}
                    - based on the newest <i>Bootstrap 4.x</i>
                </li>
                <li>
                    <a href='http://dashboards.webkom.co/vue/airframe'>
                        Vue.js
                    </a>{' '}
                ...
                <li>
                    ...
                    <i>Ruby on Rails, Ember, Laravel etc.</i>, please ask for
        ...
        <section className='mb-5'>
            <h6>Work Orders:</h6>
            <p>
                Regarding configuration, changes under client&apos;s
                requirements.
                <br />
