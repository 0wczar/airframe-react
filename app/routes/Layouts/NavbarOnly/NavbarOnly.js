        ...
        return (
            <Container>
                <p className='mb-5 mt-3'>
                    Welcome to the <b>&quot;Airframe&quot;</b> Admin Dashboard
                    Theme based on{' '}
                    <a
                    ...
                    - easy to use React Bootstrap 4 components compatible with
                    React 16+.
                </p>
                ...
                <section className='mb-5'>
                    ...
                    <ul className='pl-3'>
                        ...
                        <li>
                            ...
                            - technical details of which versions are used for
                            this framework.
                        </li>
                        <li>
                            <a
                        ...
                        <li>
                            <b>Bugs</b> - do you see errors in this version?
                            Please report vie email: <i>info@webkom.co</i>
                        </li>
                    </ul>
                </section>
                ...
                <section className='mb-5'>
                    ...
                    <ul className='pl-3'>
                        ...
                        <li>
                            ...
                            - based on the newest <i>Reactstrap</i> and{' '}
                            <i>Next.js</i>
                        </li>
                        <li>
                            <a
                        ...
                        <li>
                            ...
                            <i>Ruby on Rails, Ember, Laravel etc.</i>, please
                            ask for the beta version via email: info@webkom.co
                        </li>
                    </ul>
                </section>
