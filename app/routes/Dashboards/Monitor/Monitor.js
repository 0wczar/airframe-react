...
const Monitor = () => (
    <Container>
        ...
        <Row>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className='text-left'>
                                    <div className='small mb-2'>
                                        <i className='fa fa-circle fa-fw text-info'></i>{' '}
                                        Allocated
                                    </div>
                                ...
                                <div className='text-left'>
                                    <div className='small mb-2'>
                                        <i className='fa fa-circle fa-fw text-primary'></i>{' '}
                                        In Cache
                                    </div>
            ...
            <Col lg={8}>
                <p>
                    Nesciunt odit eius nihil molestiae tenetur earum enim
                    quidem. Aperiam non sapiente voluptatum in doloremque rerum
                    magnam quae sed. Quisquam eos non voluptate sapiente qui
                    temporibus harum in illo. Aliquid at dolor labore. Qui error
                    modi.
                </p>
                    ...
                    <Col lg={3}>
                        <div>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className='text-left'>
                                    <div className='small mb-2'>
                                        <i className='fa fa-circle fa-fw text-purple'></i>{' '}
                                        Used Space
                                    </div>
                    ...
                    <Col lg={3}>
                        <div>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className='text-left'>
                                    <div className='small mb-2'>
                                        <i className='fa fa-circle fa-fw text-success'></i>{' '}
                                        Used Space
                                    </div>
                    ...
                    <Col lg={3}>
                        <div>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className='text-left'>
                                    <div className='small mb-2'>
                                        <i className='fa fa-circle fa-fw text-yellow'></i>{' '}
                                        Used Space
                                    </div>
