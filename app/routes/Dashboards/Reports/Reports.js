        ...
        <Row className='mb-2'>
            ...
            <Col xl={3} lg={6} className='mb-4 mb-lg-0'>
                <Card>
                    ...
                    <UncontrolledCollapse
                        toggler='#TemperaturesProcessorToggler'
                        isOpen
                    >
                    ...
                    <UncontrolledCollapse
                        toggler='#TemperaturesGraphicsToggler'
                        isOpen
                    >
                        <CardBody className='pt-0'>
                    ...
                    <UncontrolledCollapse
                        toggler='#TemperaturesStorageToggler'
                        isOpen
                    >
                        <CardBody className='pt-0'>
            ...
            <Col xl={3} lg={6} className='mb-4 mb-lg-0'>
                <Card className='mb-sm-4 mb-xl-0'>
                    ...
                    <UncontrolledCollapse toggler='#ProcessorToggler' isOpen>
                        <CardBody className='pt-0'>
                            <dl className='row mb-3'>
                                ...
                                <dd className='col-sm-4 text-right text-inverse'>
                                    4 (8)
                                </dd>
                            </dl>
                            <Progress
                    ...
                    <ListGroup flush>
                        ...
                        <UncontrolledTooltip
                            placement='top'
                            target='UsageLoadTooltip'
                        >
                            Show/Hide Section
                        </UncontrolledTooltip>
                        <UncontrolledCollapse
                            toggler='#UsageLoadToggler'
                            isOpen
                        >
                            <CardBody className='pt-0'>
                                <Table size='sm' className='mb-0'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className='bt-0 text-center text-inverse'>
                                                1
                                            </td>
                                            <td className='bt-0 text-center text-inverse'>
                                                2
                                        ...
                                        <tr>
                                            <td>Usage %</td>
                                            <td className='text-center text-inverse'>
                                                27
                                            </td>
                                            <td className='text-center text-inverse'>
                                                78
                    ...
                    <ListGroup flush>
                        ...
                        <UncontrolledTooltip
                            placement='top'
                            target='UsageLoadTooltip2'
                        >
                            Show/Hide Section
                        </UncontrolledTooltip>
                        <UncontrolledCollapse
                            toggler='#UsageLoadToggler2'
                            isOpen
                        >
                            <CardBody className='pt-0'>
                                <Table size='sm'>
                                    <thead>
                                        <tr>
                                            <th
                                                scope='col'
                                                className='bt-0 bb-0 align-top text-left'
                                            >
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className='bt-0 text-right text-inverse'>
                                                390Mhz
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                >
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                scope='col'
                                                className='align-middle text-right bt-0'
                                            >
                                                Read
                                            </th>
                                            <th
