...
const SessionByDevice = (props) => (
    <div className={classes['session']}>
        ...
        <div className={classes['session__values']}>
            <div
                className={`${classes['session__percentage']} text-${props.color}`}
            >
                {props.valuePercent}%
            </div>
        ...
        return (
            <React.Fragment>
                ...
                <Grid>
                    ...
                    >
                        <Grid.Col
                            {...applyColumn('metric-v-target-users', layouts)}
                        >
                            <Card>
                                <CardHeader
                                    className='bb-0 pt-3 pb-0 bg-none'
                                    tag='h6'
                                >
                                    <i className='fa fa-ellipsis-v text-body mr-2'></i>{' '}
                                    Users
                                </CardHeader>
                                ...
                                <CardFooter>
                                    <Media className='small'>
                                        ...
                                        <Media body>
                                            ...
                                            compare to your targets over the
                                            last 30 days?
                                        </Media>
                                    </Media>
                                </CardFooter>
                        ...
                        >
                            <Card>
                                <CardHeader
                                    className='bb-0 pt-3 pb-4 bg-none'
                                    tag='h6'
                                >
                                    <i className='fa fa-ellipsis-v mr-2 text-body'></i>{' '}
                                    Analytics Audience Metrics
                                </CardHeader>
                                ...
                                <Table responsive className='table mb-0'>
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                scope='col'
                                                className='text-right bt-0'
                                            >
                                                Change
                                            </th>
                                            <th
                                                scope='col'
                                                className='bt-0 text-right'
                                            >
                                                Trend
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className='align-middle'>
                                                <span data-faker='[[finance.amount]]'>
                                                    949.00
                                                </span>
                                            </td>
                        ...
                        <Grid.Col {...applyColumn('sessions', layouts)}>
                            <Card>
                                ...
                                <CardFooter
                                    className={`${classes['sessions-info']} mt-auto`}
                                >
                                    <Media className='small'>
                                        <Media left>
                                            <i className='fa fa-fw fa-info-circle mr-2'></i>
                        ...
                        <Grid.Col
                            {...applyColumn('website-performance', layouts)}
                        >
                            <Card>
                                <CardHeader
                                    className='bb-0 pt-3 bg-none'
                            ...
                            <Card>
                                <CardHeader className='d-flex bb-0 pt-3 bg-none'>
                                    <Media>
                                        ...
                                        <Media body>
                                            <span className='h6'>
                                                How did my organic traffic
                                                perform?
                                            </span>
                                            <br />
                                            <span>
                                                Dec 22, 2016 to Dec 31, 2016{' '}
                                                <i>(prev.)</i>
                                            </span>
                                        </Media>
                                    </Media>
