                    ...
                    <HeaderDemo
                        ...
                        subTitle={
                            <React.Fragment>
                                ...
                                meaning any nested tables will be styled in the
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                ...
                                <code>.table-based</code> tables look in
                                Bootstrap. All table styles are inherited in
                                Bootstrap 4, meaning any nested tables will be
                    ...
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                ...
                                horizontally with ease. Make any table
                                responsive across all viewports by wrapping a{' '}
                                <code>Table</code> with <code>responsive</code>.
                            </p>
                        </CardBody>
                        {/* START Table */}
                        <Table className='mb-0' responsive>
                ...
                <Col lg={12}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                Use <code>striped</code> to add zebra-striping
                                to any table row within the{' '}
                                <code>&lt;tbody&gt;</code>.
                            </p>
                        </CardBody>
                        {/* START Table */}
                ...
                <Col lg={12}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                Use <code>hover</code> to add zebra-striping to
                ...
                <Col lg={12}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                Add <code>size="sm"</code> to make tables more
                ...
                <Col lg={12}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                Add <code>borderless</code> for a table without
                                borders.
                            </p>
                        </CardBody>
                        {/* START Table */}
                ...
                <Col lg={12}>
                    <Card className='mb-3'>
                        <CardBody>
                            ...
                            <p>
                                Add <code>bordered</code> for borders on all
                ...
                <Col lg={12}>
                    <Card className='mb-3' type='background' color='dark'>
                        <CardBody>
                            ...
                            <p className='mb-0'>
                                You can also invert the colors—with light text
                                on dark backgrounds—with <code>dark</code>.
                            </p>
                        </CardBody>
                        {/* START Table */}
