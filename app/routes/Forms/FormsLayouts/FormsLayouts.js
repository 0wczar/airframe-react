                    ...
                    <HeaderDemo
                        ...
                        subTitle={
                            <React.Fragment>
                                ...
                                the .row class to form groups and using the
                                .col-*-* classes to specify the width of your
                                labels and controls.
                            </React.Fragment>
                        }
                    />
                                ...
                                <FormGroup row>
                                    ...
                                    <Col sm={8}>
                                        ...
                                        <FormText color='muted'>
                                            Accepted formats: pdf, doc, txt. Max
                                            file size 7Mb
                                        </FormText>
                                    </Col>
                                </FormGroup>
            ...
            <Row>
                <Col lg={12}>
                    <HeaderDemo
                        ...
                        subTitle={
                            <React.Fragment>
                                Form controls within inline forms vary slightly
