    ...
    render() {
        ...
        return (
            <Container>
                ...
                <div className='mb-4'>
                    <p className='mb-3'>
                        Simple HTML5-compliant drag&apos;n&apos;drop zone for
                        files built with React.js.
                    </p>
                    <FileDrop
                        multiple
                        onDragEnter={() => {
                    ...
                    >
                        {({ getRootProps, getInputProps }) => (
                            <div {...getRootProps()} className={dropzoneClass}>
                                ...
                                <p className='small'>
                                    JPG, GIF, PNG, MOV, and AVI. Please choose
                                    files under 2GB for upload. File sizes are
                                    400x300px.
                                </p>
                                <input {...getInputProps()} />
                            </div>
